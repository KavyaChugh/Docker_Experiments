...
**1. [DOCKER BASICS: Hello, Container World!](https://github.com/KavyaChugh/Docker_Experiments/tree/main/1.Hello_World) 🐳**  
...
**2. [Dockerized Streamlit Development Environment](https://github.com/KavyaChugh/Docker_Experiments/tree/main/2.Streamlit_Docker/Dockers_Streamlit) 📊**  
   - **Goal:** Build a containerized Streamlit environment for smooth and efficient data visualization.  
   - **Key Focus:** Web app deployment, interactive UI, and container efficiency.  

**3. [Titanic Survival Predictor: Containerized Streamlit App](https://github.com/KavyaChugh/Docker_Experiments/tree/main/3.StreamlitModel_Docker/StreamlitModel_Docker) 🚢**  
   - **Goal:** Deploy a Machine Learning-powered Titanic survival prediction app using Streamlit and Docker.  
   - **Key Focus:** ML model serving, interactive UI, and cloud deployment.  

**4. [Containerized MySQL: Agile & Efficient](https://github.com/KavyaChugh/Docker_Experiments/tree/main/4.Docker_Mysql/MySQL_Docker) 🐬**  
   - **Goal:** Deploy MySQL in a Docker container, ensuring fast, reliable, and persistent database management.  
   - **Key Focus:** Data persistence, networking, and security.  

**5. [Docker Volume Persistence: Bind Mounts with Linux Containers](https://github.com/KavyaChugh/Docker_Experiments/tree/main/5.Docker_network/Docker_Network) 🗂️**  
   - **Goal:** Ensure data persistence and prevent loss by using Docker volumes and bind mounts.  
   - **Key Focus:** Storage management, Linux containers, and backups.  

**6. [Docker Bridge: Balancing Isolation & Connectivity](https://github.com/KavyaChugh/Docker_Experiments/tree/main/6.Docker_fullstack/Docker_FullStack) 🔗**  
...
**7. [Streamlit & PostgreSQL, Docked](https://github.com/KavyaChugh/Docker_Experiments/tree/main/7.Docker_volume/Docker_volume) 🐘**  
   - **Goal:** Connect Streamlit with PostgreSQL inside a containerized environment for real-time data interaction.  
   - **Key Focus:** Full-stack integration, database handling, and scalable applications.  

**8. [Evidently AI Sets Sail in Docker](https://github.com/KavyaChugh/Docker_Experiments/tree/main/8.Stream_evidently/Streamlit_evidently) 🧠**  
   - **Goal:** Run Evidently AI inside a Docker container to analyze ML model performance and detect data drift.  
   - **Key Focus:** AI model monitoring, automation, and analytics.  

**9. [Minikube with Docker on Windows](https://github.com/KavyaChugh/Docker_Experiments/tree/main/9.%20Minikube%20with%20Docker%20on%20Windows) ☸️**  
...
**10. [Deploying a Streamlit App in Docker on AWS EC2](https://github.com/KavyaChugh/Docker_Experiments/tree/main/10.%20Running%20a%20Streamlit%20App%20in%20Docker%20on%20AWS%20EC2) ☁️**
...
**12. [Microservices Architecture using Docker Swarm](https://github.com/KavyaChugh/Docker_Experiments/tree/main/12.%20Microservices%20Architecture%20using%20Docker%20Swarm) ⚓**  
...
**13. [Bakery Foundation Example on Windows](https://github.com/KavyaChugh/Docker_Experiments/tree/main/13.%20Bakery%20Foundation%20Example%20on%20Windows) 🍞**  
